...
const emCtl =require("../controller/EmployersController.js")
const jbpCtl=require("../controller/JostpostController.js")
...
//   router.post("/forgotPassword", authController.forgotPassword);
  ...
  router.get("/sea",jbpCtl.searchJobPostsByKeyword)
